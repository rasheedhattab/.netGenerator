...
namespace Generator.DataBase
{
    ...
    #line 1 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public partial class DBPackageBody : DBPackageBodyBase
    {
#line hidden
        /// <summary>
        ...
        {
            this.Write(" \r\n");
            this.Write(" create or replace PACKAGE BODY ");
            
            #line 26 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            ...
            #line 28 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            
            #line default
            #line hidden
            this.Write("_PRC(P_ID NUMBER ,P_REFCURSOR_OUT  OUT SYS_REFCURSOR ) \r\nIS BEGIN\r\nOPEN P_REFCURS" +
                    "OR_OUT FOR  SELECT * FROM ");
            
            #line 30 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            
            #line default
            #line hidden
            this.Write(" WHERE ID = P_ID  ;\r\nEND GET_");
            
            #line 31 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 33 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 34 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
for(int i=0;i<columnTypeList.Count;i++){ 
		...
		&& columnNameList[i]!="ID"){
            ...
            #line 41 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            ...
            #line 42 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
}}
            ...
            #line 45 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 46 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
for(int i=0;i<columnTypeList.Count;i++){ 
		if(columnNameList[i]!="DELETED_BY" 
		&& columnNameList[i]!="DELETION_DATE"
		&& columnNameList[i]!="MODIFIED_BY"
		...
		&& columnNameList[i]!="ID"){
            ...
            #line 54 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(columnNameList[i]));
            ...
            #line 55 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
}}
            
            #line default
            #line hidden
            this.Write("\t\tCREATION_DATE,CREATED_BY) VALUES(\r\n\t\t");
            
            #line 57 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
for(int i=0;i<columnTypeList.Count;i++){ 
		if(columnNameList[i]!="DELETED_BY" 
		&& columnNameList[i]!="DELETION_DATE"
		&& columnNameList[i]!="MODIFIED_BY"
		...
		&& columnNameList[i]!="ID"){
            ...
            #line 65 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(columnNameList[i]));
            ...
            #line 66 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
}}
            
            #line default
            #line hidden
            this.Write("\t\tSYSDATE,P_CREATED_BY) RETURNING ID INTO P_ID_OUT;\r\nEND  ADD_");
            
            #line 68 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 70 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 72 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            
            #line default
            #line hidden
            this.Write(" SET DELETED_BY=P_DELETED_BY ,DELETION_DATE=SYSDATE  WHERE ID=P_ID;\r\nEND DEL_");
            
            #line 73 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 75 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 76 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
for(int i=0;i<columnTypeList.Count;i++){ 
		if(columnNameList[i]!="DELETED_BY" 
		&& columnNameList[i]!="DELETION_DATE" 
		&& columnNameList[i]!="MODIFICATION_DATE"
		...
		if(i<columnTypeList.Count-6){
            ...
            #line 83 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(columnNameList[i]));
            ...
            #line 84 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
}else{
            ...
            #line 85 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(columnNameList[i]));
            ...
            #line 86 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
}}}
            ...
            #line 89 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 90 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
for(int i=0;i<columnTypeList.Count;i++){ 
		...
		&& columnNameList[i]!="CREATION_DATE"){
            ...
            #line 98 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(columnNameList[i]));
            ...
            #line 99 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
}}
            
            #line default
            #line hidden
            this.Write("\t\tMODIFICATION_DATE=SYSDATE,MODIFIED_BY=P_MODIFIED_BY WHERE ID = P_ID ;\r\nEND  UPD" +
                    "_");
            
            #line 101 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 103 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
...
BEGIN
   ...
   SELECT COUNT (*) INTO P_TOTAL_RECORDS FROM ");
            
            #line 123 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            
            #line default
            #line hidden
            this.Write(" WHERE DELETED_BY IS NULL; OPEN P_REFCURSOR_OUT FOR\r\n\r\n      SELECT *\r\n\r\n        " +
                    "FROM (  SELECT ");
            
            #line 127 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line default
            #line hidden
            this.Write(".ID desc)   IN_ROWNUM FROM ");
            ...
            #line default
            #line hidden
            this.Write(" WHERE DELETED_BY IS NULL)\r\n\r\n       WHERE IN_ROWNUM BETWEEN VV_FIRST_REC AND VV_" +
                    "LAST_REC;\r\n\r\nEND SEARCH_");
            
            #line 131 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
            ...
            #line 134 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(tableName));
        ...
        #line 135 "C:\Workspaces\Workflow\Generator\DataBase\DBPackageBody.tt"
...
if ((AngularFileNameValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class DBPackageBodyBase
    {
        #region Fields
