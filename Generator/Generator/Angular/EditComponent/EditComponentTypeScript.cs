...
namespace Generator.Angular.EditComponent
{
    ...
    #line 1 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public partial class EditComponentTypeScript : EditComponentTypeScriptBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("import { Component, OnInit } from \'@angular/core\';\r\nimport { Router, ActivatedRou" +
                    "te, Params } from \'@angular/router\';\r\nimport { ");
            
            #line 28 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            ...
            #line 29 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ClassName));
            ...
            #line 34 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(AngularFileName));
            ...
            #line 35 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(AngularFileName));
            ...
            #line 36 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(AngularFileName));
            ...
            #line 38 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ClassName));
            ...
            #line 40 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            ...
            #line default
            #line hidden
            this.Write("Service, private router: Router, private route: ActivatedRoute, public notifyServ" +
                    "ice: NotifyService) { }\r\n    ");
            
            #line 41 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ObjectName));
            ...
            #line 42 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ObjectName));
            
            #line default
            #line hidden
            this.Write("Id: number;\r\n    ngOnInit() {\r\n        this.route.queryParams.subscribe((params: " +
                    "Params) => {\r\n        this.");
            
            #line 45 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ObjectName));
            
            #line default
            #line hidden
            this.Write("Id = params[\"id\"];\r\n        this.");
            
            #line 46 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ObjectName));
            
            #line default
            #line hidden
            this.Write("Service.get(this.");
            ...
            #line default
            #line hidden
            this.Write("Id).subscribe((resp: any) => {\r\n            this.");
            
            #line 47 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ObjectName));
            
            #line default
            #line hidden
            this.Write(" = resp != null ? resp : new ");
            ...
            #line 51 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ClassName));
            ...
            #line 52 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ObjectName));
            
            #line default
            #line hidden
            this.Write("Service.update(this.");
            ...
            #line default
            #line hidden
            this.Write(@").subscribe((res: any) => {
            if (res > 0) {
                this.notifyService.showSuccessMessageBox(""UpdatedSuccessfly"", """");
                this.backToList();
            }
    ...
    backToList() {
      this.router.navigate(['/");
            ...
            #line 61 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ObjectName));
        ...
        #line 65 "C:\Workspaces\Workflow\Generator\Angular\EditComponent\EditComponentTypeScript.tt"
...
if ((AngularFileNameValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class EditComponentTypeScriptBase
    {
        #region Fields
